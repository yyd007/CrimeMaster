...
print 'Add_book connected successfully!<br>';
...
echo '<input type="text" name="AuthorName" required/><br>';
print '<br>Enter Languages:<br>';
echo '<input type="text" name="Languages"required/><br>';
print '<br>Enter Length:<br>';
echo '<input type="text" name="Length" required/><br>';
print '<br>Enter Country:<br>'; 
echo '<input type="text" name="Country" required/><br>';
